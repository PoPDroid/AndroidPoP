...
public class PoPPuzzleChallenge_v2_0 extends AppCompatActivity implements SensorEventListener {
    ...
    public class AnimatedView extends ImageView {
        ...
        private void drawPaths() {
            ...
            mitigation.setBounds((screenWidth/2)-(width*5),shift-width,(screenWidth/2)+(width*5),shift+(width*4)) ;
